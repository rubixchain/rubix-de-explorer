...
var (
	...
	// FT: {Name}_{CreatorDID}_{Index}. Name can contain any character except
	// '_' (the segment separator) — hyphens, dots, etc. are allowed.
	ftRegex = regexp.MustCompile(`^[^_]+_bafy[abcdefghijklmnopqrstuvwxyz234567]{55}_\d+$`)
