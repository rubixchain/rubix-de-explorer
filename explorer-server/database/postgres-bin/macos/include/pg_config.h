...
#define CONFIGURE_ARGS " '--with-icu' '--enable-debug' '--prefix=/opt/pginstaller_17.auto/server/staging_cache/osx' '--with-ldap' '--with-openssl' '--with-perl' '--with-python' '--with-tcl' '--with-bonjour' '--with-pam' '--enable-thread-safety' '--with-libxml' '--with-uuid=e2fs' '--with-includes=/opt/local/Current_v15/include/libxml2:/opt/local/Current_v15/include:/opt/local/Current_v15/include/security:/opt/local/Current_v15/include/openssl/' '--docdir=/opt/pginstaller_17.auto/server/staging_cache/osx/doc/postgresql' '--with-libxslt' '--with-libedit-preferred' '--with-gssapi' '--with-lz4' '--with-zstd' 'CFLAGS=-isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX14.sdk -mmacosx-version-min=12 -arch x86_64 -arch arm64 -O2' 'LDFLAGS=-L/opt/local/Current_v15/lib' 'ICU_CFLAGS=-I/opt/local/Current_v15/include' 'ICU_LIBS=-L/opt/local/Current_v15/lib -licuuc -licudata -licui18n' 'XML2_CONFIG=/opt/local/Current_v15/bin/xml2-config' 'LZ4_CFLAGS=-I/opt/local/Current_v15/include' 'LZ4_LIBS=-L/opt/local/Current_v15/lib' 'ZSTD_CFLAGS=-I/opt/local/Current_v15/include' 'ZSTD_LIBS=-L/opt/local/Current_v15/lib' 'PERL=/Library/edb/languagepack/v5/Perl-5.40/bin/perl' 'PYTHON=/Library/edb/languagepack/v5/Python-3.12/bin/python3'"
...
#define PG_VERSION_STR "PostgreSQL 17.6 on x86_64-apple-darwin23.6.0, compiled by Apple clang version 16.0.0 (clang-1600.0.26.6), 64-bit"
